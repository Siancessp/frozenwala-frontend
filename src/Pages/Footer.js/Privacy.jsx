    ...
    <Navbar/>
      <div className="container mt-8 mb-8">
        ...
        <p>
          ...
          aware of any changes, please review this policy periodically. We
          receive information about you from various sources, including but not
          limited to: (i) if you register for the site and the offerings,
          through your user account on the offerings (your “Account”); (ii) your
          use of the offerings generally; and (iii) from third-party websites
          and services. When you use the offerings, you are consenting to the
          collection, transfer, manipulation, storage, disclosure, and other
          uses of your information as described in this Privacy Policy. This
          Privacy Policy covers the treatment of personally identifiable
        ...
        <p>
          ...
          privacy and security standards. However, we cannot take responsibility
          for third party service providers. We urge you to carefully review the
        ...
        <p>
          ...
          and optimized experience to our users. It helps us improve and update
          the offerings for the users. We only collect information that we
          consider necessary to achieve this purpose. You can browse the website
          anonymously without revealing your identity or any personal
          ...
          particular service or feature on the website. On the usage of our
          website whether by logging in or simply surfing, we may collect
          behavioral information. We use this information to analyze users'
          demographics, interests, and behavior to better understand, protect
          and serve our users at aggregate levels. This information may include
          the URL from which the user was directed (whether this URL is on our
          website or not), the URL which the user leaves for (whether this URL
          is on our website or not), computer browser information, and the IP
          address. We use “cookies” for data collection. The information
          collected is used to analyze the effectiveness of the website
          features, webpage flow, and experience. Cookies also allow users to
          enter the password less frequently during a session. You may choose to
          disable the cookies and still use the website. This may limit certain
          useful features on the site. We do not control third-party cookies or
          similar elements on some pages of the website. We may collect
          different types of information on website usage. We collect
          information on buying behavior on purchases being made on the website.
          We also collect additional information, such as a billing address, a
          credit/debit card number, a credit/debit card expiration date, and/ or
          other payment instrument details and tracking information from cheques
          or money orders on transactions. We also collect information from
          discussions and message boards or feedback. We may retain this
          information as necessary to resolve disputes, provide customer support
          and troubleshoot problems as permitted by law. We may also collect
        ...
        <p>
          When you create an Account, you will provide information that could be
          Personal Information, such as your username, password, and email
          address. You acknowledge that this information may be personal to you,
          and by creating an account on the website and providing Personal
          Information to us, you allow others, including us, to identify you and
          therefore may not be anonymous. We may use your contact information to
          send you information about our offerings, but only rarely when we feel
          such information is important. You may unsubscribe from these messages
          through your Account settings, although we, regardless, reserve the
          right to contact you when we believe it is necessary, such as for
          account recovery purposes. Usage of certain features on the website
          may require registration and sharing of information such as email
          address, name, phone number, credit card/debit card / other payment
          instrument details, etc. If you choose to buy products / services from
          the website, we collect information about your buying behavior. If you
          transact with us, we collect some additional information, such as a
          billing address, a credit/debit card number, a credit/debit card
          ...
          messages on our message boards, chat rooms, or other message areas or
          leave feedback, we will collect that information you provide to us. We
        ...
        <h4>Use of demographic and profile data</h4>
        <p>
          We use your personal information to resolve disputes; troubleshoot
          problems; help promote a safe service; collect money; measure consumer
          ...
          described to you at the time of collection. We will occasionally ask
          you to complete optional online surveys. These surveys may ask you for
          contact information and demographic information (like pin code, age,
          education, or income). We use this data to tailor your experience at
          our website, providing you with content that we think you might be
        ...
        <p>
          ...
          to prevent abuse of our services, and facilitate joint or co-branded
          ...
          market to you as a result of such sharing unless you are explicitly
          ...
          necessary to respond to subpoenas, court orders, or another legal
          ...
          that such disclosure is reasonably necessary to: (i) enforce our Terms
          or Privacy Policy; (ii) respond to claims that an advertisement,
          posting or other content violates the rights of a third party; or
          (iii) protect the rights, property or personal safety of our users or
          the general public. We may use third party service providers to
          provide website and application development, hosting, maintenance,
          backup, storage, payment processing, analysis and other services for
          us, which may require them to access or use information about you. If
          a service provider needs to access information about you to perform
          services on our behalf, they do so under close instruction from us,
          including policies and procedures designed to protect your
          information. All of our service providers and partners agree to strict
        ...
        <p>
          ...
          granted access to personally identifiable information. If you have any
          questions about the security at our website, please email us on the
          email id mentioned below. While we implement safeguards designed to
          protect your information, no security system is impenetrable and due
          to the inherent nature of the internet, we cannot guarantee that data,
          ...
          others. When our registration/order process asks you to enter
          sensitive information (such as a credit card number), such information
          is encrypted and is protected with the best encryption software in the
          industry. Information kept by us: We keep your personal information
          only as long as you use our service and also as permitted/required by
          ...
          comply with legal obligations, fraud prevention, take actions we deem
          necessary to protect the integrity of our Website and App or our
          users, to resolve disputes, to enforce our agreements, to support
          business operations, and to continue to develop and improve our
          services. We retain information for better services, and we only use
          the information to analyze about the use of our services, not to
